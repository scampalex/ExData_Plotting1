...
plot(data_clean$DateTime,data_clean$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
plot(data_clean$DateTime,data_clean$Voltage,type = "l", xlab = "datetime", ylab = "Voltage")
...
legend("topright",legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col = c("black","red", "blue"), lty = 1, border = "")

plot(data_clean$DateTime,data_clean$Global_reactive_power,type = "l",xlab = "datetime", ylab = "Global_reactive_power")
